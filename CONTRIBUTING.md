...
Microsoft and Google login, Microsoft 365, Google Workspace, GitHub MCP, and
customer SSO trusted-origin fields remain visible when blank, alongside email
transport and invitation delivery mode. Ordinary internal defaults remain in the
contract; worktree Docker names and image tags derive from its generated
installation ID.
