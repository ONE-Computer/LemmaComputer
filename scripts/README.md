...
| [render-env-example.mjs](setup/render-env-example.mjs) | Checks the generated environment reference files; append `-- --write` to regenerate them. | `npm run env:example` / `npm run env:qualification:example` |
