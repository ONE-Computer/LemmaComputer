...
const generatedSecretNames = [
  ...
  "ONECOMPUTER_ONEVIBE_CAPTURE_SECRET",
...
export const environmentAliases = new Map([
  ...
  ["ONECOMPUTER_SESSION_SECRET", "ONECOMPUTER_LITELLM_CREDENTIAL_SECRET"],
  ["ONECOMPUTER_WORKSPACE_INGRESS_SECRET", "ONECOMPUTER_LITELLM_CREDENTIAL_SECRET"],
]);
