...
const availableAgents = [
  { id: "codex-cli", displayName: "Codex CLI", clientVersion: "0.154.0", description: "Governed Codex CLI", license: "Apache-2.0", source: "https://github.com/openai/codex", artifactSha256: "5".repeat(64), resources: { memoryMiB: 1024 } },
  {
    id: "claude-desktop",
...
const archivedChatSession = {
  ...
  workspaceDisplayName: "Project archive",
...
const archivedArtifact = {
  ...
  workspaceDisplayName: archivedChatSession.workspaceDisplayName,
  workspaceDeleted: true,
  ...
  if (request.method === "POST" && forkChatSessionMatch && [workspaceId, productWorkspaceId].includes(decodeURIComponent(forkChatSessionMatch[1]))) {
    ...
    request.on("end", () => {
      ...
      response.end(JSON.stringify({
        ...
        workspaceDisplayName: fixtureWorkspaces.find((item) => item.id === targetWorkspaceId)?.displayName ?? null,
