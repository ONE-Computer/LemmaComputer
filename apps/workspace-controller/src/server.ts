...
const envSchema = z.object({
  ...
  WORKSPACE_RELAY_CLIENT_COMMON_NAME: z.string().min(1).max(128).default("lemmacomputer-workspace-ingress"),
...
export function adapterFromEnv(env: z.infer<typeof envSchema>): SandboxAdapter {
  ...
  return new DockerKasmVncAdapter({
    ...
    relayTlsClientCa: env.WORKSPACE_NODE_TLS_CA_B64 ? Buffer.from(env.WORKSPACE_NODE_TLS_CA_B64, "base64").toString("utf8") : undefined,
    relayTlsClientCommonName: env.WORKSPACE_RELAY_CLIENT_COMMON_NAME,
    ...
    applicationTlsClientCertificate: env.WORKSPACE_NODE_APPLICATION_TLS_CLIENT_CERT_B64 ? Buffer.from(env.WORKSPACE_NODE_APPLICATION_TLS_CLIENT_CERT_B64, "base64").toString("utf8") : undefined,
    applicationTlsClientKey: env.WORKSPACE_NODE_APPLICATION_TLS_CLIENT_KEY_B64 ? Buffer.from(env.WORKSPACE_NODE_APPLICATION_TLS_CLIENT_KEY_B64, "base64").toString("utf8") : undefined,
