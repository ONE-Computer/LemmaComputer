...
export const siteApi = {
  ...
  setGrantPermission: (id: string, accountUserId: string, permission: string) => request(`/api/v1/sites/${encodeURIComponent(id)}/grants`, mutation("POST", { accountUserId, permission })),
