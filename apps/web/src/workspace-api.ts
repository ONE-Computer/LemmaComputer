...
export const adminApi = {
  ...
  protectedMemberPolicyVersions: (userId: string) => request(`/api/v1/admin/protected-workspace-policy/members/${encodeURIComponent(userId)}/assignment-versions`, { cache: "no-store" }),
  assignProtectedMemberPolicy: (userId: string, selection: unknown) => request(`/api/v1/admin/protected-workspace-policy/members/${encodeURIComponent(userId)}/assignment-versions`, mutation("POST", { selection })),
  revokeProtectedMemberPolicy: (userId: string) => request(`/api/v1/admin/protected-workspace-policy/members/${encodeURIComponent(userId)}/assignment-versions`, mutation("DELETE")),
  ...
  routingSettings: (teamId: string) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing`, { cache: "no-store" }),
  routingShadowReport: (teamId: string) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing/shadow-report`, { cache: "no-store" }),
  ...
  saveRoutingPolicy: (teamId: string, input: unknown) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing/policy`, mutation("PUT", input)),
  saveRoutingReview: (teamId: string, input: unknown) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing/reviews`, mutation("POST", input)),
  changeRoutingRollout: (teamId: string, input: unknown) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing/rollout`, mutation("POST", input)),
  routingKillSwitch: (teamId: string, input: unknown) => request(`/api/v1/admin/teams/${encodeURIComponent(teamId)}/routing/kill-switch`, mutation("POST", input)),
