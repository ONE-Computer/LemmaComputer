...
export const adminApi = {
  ...
  clearUserWorkspaceEgressSecurityGroup: (userId: string, grantId: string) => request(`/api/v1/admin/users/${encodeURIComponent(userId)}/workspaces/${encodeURIComponent(grantId)}/egress-security-group`, mutation("DELETE")),
