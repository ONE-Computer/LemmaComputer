...
export const adminApi = {
  ...
  retryConnectorPolicyDelivery: (connectorId) => request(`/api/v1/admin/connectors/${encodeURIComponent(connectorId)}/policy-delivery/retry`, mutation("POST")),
  ...
  saveConnectorToolPolicy: (connectorId, tools, expectedDocumentHash, expectedAccessPolicyVersion) => request(`/api/v1/admin/connectors/${encodeURIComponent(connectorId)}/tool-policy`, mutation("PUT", { tools, expectedDocumentHash, expectedAccessPolicyVersion })),
