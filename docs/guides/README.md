...
| [Operations](operations.md) | Run, monitor, back up, restore, or troubleshoot an installed stack. |
| [Local Microsoft deployment](local-deployment.md) | Exercise customer-managed Entra sign-in and Microsoft 365 integration locally. |
