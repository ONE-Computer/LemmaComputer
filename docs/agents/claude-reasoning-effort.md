...
| Hermes Agent CLI | `0.21.3` | Qualified Low, Medium, High, plus product Auto | `hermes-claw-0.21.3-governed-effort-adapter-2026-09-21`; see [Hermes runtime upgrade qualification](hermes-runtime-upgrade-qualification.md) |
| Hermes Desktop | `0.17.2` | Qualified native Low, Medium, High | `hermes-desktop-0.17.2-governed-effort-adapter-2026-09-21`; Desktop does not expose Auto |
