...
| Codex CLI | `0.153.4` (Python SDK `0.147.0`) | Discovery under `codex-cli-0.153.4-governed-effort-discovery-2026-09-08` | Governed route; no Codex-native `effort` is trusted as policy | No selector until the live gates pass |
