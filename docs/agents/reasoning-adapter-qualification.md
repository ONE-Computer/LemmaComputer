...
| Hermes Agent CLI | `0.21.3` | Discovery under `hermes-claw-0.21.3-governed-effort-discovery-2026-09-20` | Governed route from signed task binding after promotion | The candidate retains Lite, Balanced, and Pro, but receives no governed thinking-effort options until its remaining live denial gate passes |
| Hermes Desktop | `0.17.2` | Discovery under `hermes-desktop-0.17.2-governed-effort-discovery-2026-09-20` | Governed route from signed task binding after promotion | The candidate hides unsupported effort values on LemmaComputer routes, but Control does not authorize governed effort until promotion |
